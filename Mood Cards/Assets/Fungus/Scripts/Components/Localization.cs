...
using System.Text;
using Ideafixxxer.FungusCsvParser;
...
namespace Fungus
{
    ...
    public class Localization : MonoBehaviour, ISubstitutionHandler
    {
        ...
        {
            FungusCsvParser FungusCsvParser = new FungusCsvParser();
            string[][] csvTable = FungusCsvParser.Parse(csvData);
        ...
        public virtual void SetActiveLanguage(string languageCode, bool forceUpdateSceneText = false)
        {
            ...
            FungusCsvParser fungusCsvParser = new FungusCsvParser();
            string[][] csvTable = fungusCsvParser.Parse(localizationFile.text);
